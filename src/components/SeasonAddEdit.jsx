...
const SeasonAddEdit = () => {
    ...
    useEffect(() => {
        if (id) {
            setTitleForm("Editar Temporada de Viaje");
            seasonService
                .get(id)
                .then((response) => {
            ...
            setTitleForm("Nueva Temporada de Viaje");
        }
    }, [id]);
        ...
        <Box sx={{ maxWidth: 600, margin: "40px auto", padding: "0 20px" }}>
            ...
            <Card sx={{ boxShadow: "0 4px 12px rgba(0,0,0,0.1)", borderRadius: "12px" }}>
                <CardContent sx={{ p: 4 }}>
                    ...
                    <Box component="form" onSubmit={saveSeason} noValidate>
